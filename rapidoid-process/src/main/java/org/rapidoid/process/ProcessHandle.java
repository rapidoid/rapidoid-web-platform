...
public class ProcessHandle extends AbstractManageable {
	...
	private final static Set<org.rapidoid.process.ProcessHandle> ALL = Coll.synchronizedSet();
	...
	private static void terminateProcesses() {
		for (org.rapidoid.process.ProcessHandle proc : Coll.copyOf(ALL)) {
			proc.terminate();
		}
	}
	...
	public org.rapidoid.process.ProcessHandle waitFor() {
		try {
	...
	public org.rapidoid.process.ProcessHandle waitFor(long timeout, TimeUnit unit) {
		try {
	...
	public org.rapidoid.process.ProcessHandle destroy() {
		if (process != null) process.destroy();
		return this;
	}

	public org.rapidoid.process.ProcessHandle destroyForcibly() {
	...
	public synchronized org.rapidoid.process.ProcessHandle restart() {
		terminate();
	...
	public synchronized org.rapidoid.process.ProcessHandle terminate() {
		// keep reference to the handle, used by the crawler internally
		ALL.remove(this);
